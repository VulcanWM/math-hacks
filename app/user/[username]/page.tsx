                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            ...
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
                                    ...
                                    <div className="text-center p-3 bg-background rounded-lg border">
                                        <div className="text-2xl font-bold text-primary">{user.stats.averageScore}</div>
                        ...
                        <div className="space-y-6">
                            ...
                            <Card className="bg-primary/5 border-primary/20">
                                ...
                                <CardContent className="space-y-3 text-sm">
                                    <div className="flex items-center justify-between">
                                        <span className="text-muted-foreground">Total Mathathons</span>
                                        <span className="font-semibold">{user.stats.mathathonsJoined}</span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="font-semibold">{user.stats.averageScore}/100</span>
                                    </div>
                                    <div className="flex items-center justify-between">
